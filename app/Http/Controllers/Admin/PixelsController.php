...
class PixelsController extends Controller
{
    ...
    {
        $this->middleware('permission:pixels-list|pixels-create|pixels-edit|pixels-delete', ['only' => ['index', 'show']]);
        $this->middleware('permission:pixels-create', ['only' => ['create', 'store']]);
        $this->middleware('permission:pixels-edit', ['only' => ['edit', 'update']]);
        $this->middleware('permission:pixels-delete', ['only' => ['destroy']]);
    }

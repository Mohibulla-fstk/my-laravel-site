...
class BannerController extends Controller
{
    ...
    {
        $categories = BannerCategory::orderBy('id', 'DESC')->select('id', 'name', 'text_field')->get();
    ...
    public function store(Request $request)
    {
        ...
        $input['text_status'] = $request->has('text_status') ? 1 : 0;
        $input['image'] = $fileUrl;
        Banner::create($input);
    ...
    public function edit($id)
    {
        ...
        $categories = BannerCategory::select('id', 'name', 'text_field')->get();

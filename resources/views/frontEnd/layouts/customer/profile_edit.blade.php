            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="customer-content checkout-shipping">
                        ...
                        <form action="{{route('customer.profile_update')}}" method="POST" class="row"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{$profile_edit->name}}" required>
                                    @error('name')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" id="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{$profile_edit->email}}" required>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <select id="district"
                                        ...
                                        @foreach($districts as $key => $district)
                                            <option value="{{$district->district}}"
                                                @if($profile_edit->district == $district->district) selected @endif>
                                                {{$district->district}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="area" class="form-control area select2 @error('area') is-invalid @enderror"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" id="image" class="form-control @error('image') is-invalid @enderror"
                                        name="image" value="{{Auth::guard('customer')->user()->image}}">

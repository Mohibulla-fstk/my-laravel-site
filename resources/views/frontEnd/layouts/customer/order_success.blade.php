        ...
        <div class="row justify-content-center">
            <div class="col-sm-8">
                ...
                <div class="success-title">
                    <h2>Your order has been successfully received by us, a representative will call you shortly.</h2>
                </div>
                ...
                <!-- success table -->
                <h5 class="my-4">Pay with cash on delivery</h5>
                <div class="success-table">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><p><strong>৳ {{$value->sale_price}} X {{ $value->qty }}</strong></p></td>
                            </tr>
                            @endforeach
                            <tr>
                                <th  class="text-end px-4">Total</th>
                                <td><strong id="net_total">৳ {{$value->sale_price * $value->qty}}</strong></td>
                            </tr>
                             <tr>

                                <th  class="text-end px-4">Coupon Discount</th>
                                <td>
                                    <strong id="grand_total">৳ -{{$order->discount}}</strong>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <p><span style="font-weight: bold">Note: </span>{{$order->shipping?$order->shipping->note:''}}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>

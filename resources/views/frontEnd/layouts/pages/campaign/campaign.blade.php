...
{!! $generalsetting->header_code !!}
    ...
    <body>
         <div class="blankspace" style="margin: 80px;"></div>
<div class="gradient-bg">
       <strong>{{$campaign_data->banner_title}}</strong>
    </div>
         @php
        ...
        <section style="background-image: radial-gradient(at center center, #1a1a1b 28%, #231736ff 79%)" class="homeproduct">

...
@section('title') 
  <title>{{ $childcategory->meta_title }}</title>
...
<div class="gradient-bg">
       <span>{{ $childcategory->childcategoryName }}</span>
       <div>Totall {{ $products->count() }} Products on {{ $childcategory->childcategoryName }}</div>
    </div>
...
<div class="sidebar_item wraper__item">
    ...
    <label class="size">
        <input type="checkbox" name="size[]" value="{{ $size }}"
            {{ is_array(request('size')) && in_array($size, request('size'))}}>
        {{ $size }}
    </label><br>
@endforeach
                        </div>
...
<section class="product-section">
  ...
  <p>-{{ number_format($discount,0) }}%</p>
                            ...
                            @endif
                            <!--@if($soldShow && $value->sold)-->
                            <!--    <div class="sale-badge" style="left:4px;">-->
                            <!--        <div class="sale-badge-inner">-->
                            <!--            <div class="sale-badge-box">-->
                            <!--                <span class="sale-badge-text">-->
                            <!--                    <p class="text-center"> {{$value->sold}}</p>-->
                            <!--                    SOLD-->
                            <!--                </span>-->
                            <!--            </div>-->
                            <!--        </div>-->
                ...
                @endif
                        ...
                        <!-- <div class="pro_btn">
                            ...
                            <div class="cart_btn order_button">
                                <a href="{{ route('product',$value->slug) }}" class="addcartbutton">Order Now</a>
                            </div>

...
<div class="gradient-bg">
       <span>{{ $products->total() }} Results for: "{{ $keyword }}"</span>
    </div>
...
<div class="hero-2part">
 ...
 <div class="sidebar_item wraper__item">
        ...
        <!-- SORTING -->
        <!-- <div class="sidebar_item wraper__item">
            <div class="accordion" id="sort_sidebar">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseSort" aria-expanded="true" aria-controls="collapseSort">
                            Sort
                        </button>
                    </h2>
                    <div id="collapseSort" class="accordion-collapse collapse show"
                         data-bs-parent="#sort_sidebar">
                        <div class="accordion-body cust_according_body">
                            <ul class="sort">
                                <li><label><input type="checkbox" name="sort" value="1" {{ request()->sort == 1 ? 'checked' : '' }}> Newest First</label></li>
                                <li><label><input type="checkbox" name="sort" value="2" {{ request()->sort == 2 ? 'checked' : '' }}> Oldest First</label></li>
                                <li><label><input type="checkbox" name="sort" value="3" {{ request()->sort == 3 ? 'checked' : '' }}> Price High to Low</label></li>
                                <li><label><input type="checkbox" name="sort" value="4" {{ request()->sort == 4 ? 'checked' : '' }}> Price Low to High</label></li>
                                <li><label><input type="checkbox" name="sort" value="5" {{ request()->sort == 5 ? 'checked' : '' }}> Name A-Z</label></li>
                                <li><label><input type="checkbox" name="sort" value="6" {{ request()->sort == 6 ? 'checked' : '' }}> Name Z-A</label></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="wishlist-btn">
                                    <button type="button" class="wishlist-toggle" data-product-id="{{ $value->id }}">
                                        @if($inWishlist)
                                           ...
                                           <svg class="wishlist-icon" width="24" height="24" aria-hidden="true" role="img" focusable="false" style="color: red;">
            ...
            @endif
              ...
              <div class="sizeShowproduct">
                ...
                @endif
                        ...
                        <!-- <div class="pro_btn">
                            <div class="cart_btn">
                                <a href="{{ route('product',$value->slug) }}" class="addcartbutton">Add to Cart</a>
                            </div>

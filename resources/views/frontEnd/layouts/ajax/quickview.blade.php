<div class="modal-view quick-product">
    ...
    <div class="quick-product-content">
        <div class="product-details-cart">
            ...
            <p style="display: none;" class="product_star"><i class="fa-solid fa-star"></i><i
                    class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                    class="fa-solid fa-star"></i> ({{$data->reviews_count}} customer review)</p>
            <p class="details-price">৳{{$data->new_price}} @if($data->old_price)<del>৳{{$data->old_price}}</del>@endif
            </p>
            ...
            <a href="{{route('product', ['id' => $data->id])}}" style="display: none;" class="details-wishlist">Go To
                Details</a>

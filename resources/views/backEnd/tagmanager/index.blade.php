            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{route('tagmanagers.create')}}" class="btn btn-primary rounded-pill">Manage</a>
                    </div>
                    <h4 class="page-title">Tag Manager Manage</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="button-list">
                                                ...
                                                <a href="{{route('tagmanagers.edit', $value->id)}}"

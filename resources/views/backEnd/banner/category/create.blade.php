    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Banner Category Create</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('banner_category.store')}}" method="POST" class=row data-parsley-validate=""
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    <label for="text_field" class="d-block">Text Field</label>
                                    <label class="switch">

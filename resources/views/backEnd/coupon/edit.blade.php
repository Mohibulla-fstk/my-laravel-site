    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('coupon.index') }}" class="btn btn-primary rounded-pill">Manage</a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('coupon.update', $coupon->id) }}" method="POST" class="row"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group mb-3">
                                    <input type="number" step="0.01" placeholder="Max Discount"
                                ...
                                <div class="form-group mb-3">
                                    <input type="number" step="0.01" placeholder="Min Order Total"
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="is_active" {{ $coupon->is_active ? 'checked' : '' }}>

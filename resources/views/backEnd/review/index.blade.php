                            ...
                            <tbody>
                                @foreach($show_data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            @if($value->product_id)
                                                Product Review: {{ Str::limit($value->review, 50) }}
                                            @elseif($value->combo_id)
                                                Combo Review: {{ Str::limit($value->review, 50) }}
                                            @endif
                                        </td>
                                        <td>{{ $value->rating ?? $value->ratting }}</td>
                                        <td>
                                            <div class="button-list">
                                                ...
                                                <a href="{{ route('reviews.edit', $value->id) }}"

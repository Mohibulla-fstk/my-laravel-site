          ...
          <form action="{{route('products.update')}}" method="POST" class="row" data-parsley-validate="" enctype="multipart/form-data" name="editForm">
            ...
            <div class="col-sm-4">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control @error('product_code') is-invalid @enderror" name="product_code" value="{{ $edit_data->product_code }}" id="product_code" />
                @error('product_code')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="col-sm-4">
                <div class="form-group mb-3">
                    ...
                    <select class="form-control select2" name="stockstatus" id="stockstatus">
                        <option value="">Select</option>
                        <option value="IN STOCK" {{ (old('stockstatus', $edit_data->stockstatus) == 'IN STOCK') ? 'selected' : '' }}>IN STOCK</option>
                        <option value="STOCK OUT" {{ (old('stockstatus', $edit_data->stockstatus) == 'STOCK OUT') ? 'selected' : '' }}>STOCK OUT</option>
                    </select>
                    @error('stockstatus')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
   ...
   <div class="col-sm-6">
    <div class="form-group mb-3">
        ...
        <select class="form-control select2" name="sizeType">
            <option value="">Select</option>
            <option value="Chest" {{ (old('sizeType', $edit_data->sizeType) == 'Chest') ? 'selected' : '' }}>Chest Size</option>
            <option value="Waist" {{ (old('sizeType', $edit_data->sizeType) == 'Waist') ? 'selected' : '' }}>Waist Size</option>
        </select>
        @error('sizeType')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
...
$(document).ready(function() {
    function updateStockStatus() {
        let stockVal = parseInt($('#stock').val()) || 0; // stock value, 0 if empty/invalid
        if(stockVal > 0) {
    ...
    // Auto-update when user types in the stock field

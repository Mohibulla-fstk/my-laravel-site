        ...
        <div class="card">
          <div class="card-body">
            <form action="{{route('products.store')}}" method="POST" class="row" data-parsley-validate=""
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="category_id" class="form-label">Categories *</label><br>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="subcategory_id" class="form-label">SubCategories (Optional)</label><br>
                  <select class="form-control select2 @error('subcategory_id') is-invalid @enderror" id="subcategory_id"
                    name="subcategory_id" data-placeholder="Choose ...">
                    <optgroup>
                      <option value="">Select..</option>
                    </optgroup>
                  </select>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="childcategory_id" class="form-label">Child Categories (Optional)</label><br>
              ...
              <div class="col-sm-4">
                <div class="form-group mb-3">
                  <label for="category_id" class="form-label">Brands</label><br>
              ...
              <div class="col-sm-4">
                <div class="form-group mb-3">
                  <label for="purchase_price" class="form-label">Purchase Price *</label><br>
                  <input type="text" class="form-control @error('purchase_price') is-invalid @enderror"
                    name="purchase_price" value="{{ old('purchase_price') }}" id="purchase_price" required />
              ...
              <div class="col-sm-4">
                <div class="form-group mb-3">
                  <label for="old_price" class="form-label">Old Price *</label><br>
                  <input type="text" class="form-control @error('old_price') is-invalid @enderror" name="old_price"
                    value="{{ old('old_price') }}" id="old_price" />
                  @error('old_price')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-sm-4">
                <div class="form-group mb-3">
                  <label for="new_price" class="form-label">New Price *</label><br>
                  <input type="text" class="form-control @error('new_price') is-invalid @enderror" name="new_price"
                    value="{{ old('new_price') }}" id="new_price" required />
                  @error('new_price')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-sm-4">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control @error('product_code') is-invalid @enderror" name="product_code"
                    value="{{ old('product_code') }}" id="product_code" />
                  @error('product_code')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                    ...
                    <select class="form-control select2" name="stockstatus" id="stockstatus">
                        <option value="">Select</option>
                        <option value="IN STOCK" {{ old('stockstatus') == 'IN STOCK' ? 'selected' : '' }}>IN STOCK</option>
                        <option value="STOCK OUT" {{ old('stockstatus') == 'STOCK OUT' ? 'selected' : '' }}>STOCK OUT</option>
                    </select>
                    @error('stockstatus')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="pro_unit" class="form-label">Product Unit (Optional)</label><br>
                  <input type="text" class="form-control @error('pro_unit') is-invalid @enderror" name="pro_unit"
                    value="{{ old('pro_unit') }}" id="pro_unit" />
                  @error('pro_unit')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="pro_video" class="form-label">Product Video (link only)</label><br>
                  <input type="text" class="form-control @error('pro_video') is-invalid @enderror" name="pro_unit"
                    value="{{ old('pro_video') }}" id="pro_video" />
                  @error('pro_video')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
              ...
              <div class="col-sm-6">
                <div class="form-group mb-3">
                  <label for="sizeType" class="form-label">Size Type *</label><br>
                  <select class="form-control select2" name="sizeType">
                    <option value="">Select</option>
                    <option value="Chest" {{ old('sizeType') == 'Chest' ? 'selected' : '' }}>Chest Size</option>
                    <option value="Waist" {{ old('sizeType') == 'Waist' ? 'selected' : '' }}>Waist Size</option>
                  </select>
                  @error('sizeType')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                ...
                <div class="col-sm-6">
                  <div class="form-group mb-3">
                    <label for="color" class="form-label">Size (Optional)</label><br>
                ...
                <div class="col-sm-6">
                  <div class="form-group mb-3">
                    <label for="color" class="form-label">Color (Optional)</label><br>
                ...
                <div class="col-sm-3 mb-3">
                  <div class="form-group mb-3">
                    <label for="sold" class="form-label">Sold</label><br>
                    <input type="text" class="form-control @error('sold') is-invalid @enderror" name="sold"
                      value="{{ old('sold') }}" id="sold" />
                    @error('sold')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                ...
                <div class="col-sm-3 mb-3">
                  <div class="form-group">
                    <label for="topsale" class="d-block">Hot Deals</label><br>
                    <label class="switch">
                ...
                <div class="col-sm-3 mb-3">
                  <div class="form-group">
                    <label for="flashsale" class="d-block">Flash Sales</label><br>
                    <label class="switch">
  ...
  <script>
    $(document).ready(function () {
      ...
      $(document).on('click', '.add-row', function () {
        var newRow = $("#size-template .size-row").clone();
        $("#size-wrapper").append(newRow);

        // প্রথম row-এর + আগের মতই থাকবে, নতুনগুলোতে remove হবে
      });
...
$(document).ready(function() {
    function updateStockStatus() {
        // Get the stock value as integer, default 0
        let stockVal = parseInt($('#stock').val()) || 0;

        // Set stockstatus based on stock value
        if(stockVal > 0) {
            $('#stockstatus').val('IN STOCK').trigger('change');
        } else {
            $('#stockstatus').val('STOCK OUT').trigger('change');
        }
    }
    ...
    // Update stockstatus every time stock input changes

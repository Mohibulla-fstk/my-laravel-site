                ...
                <form action="{{route('users.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('company_position') is-invalid @enderror" name="company_position" value="{{ old('company_position') }}" id="company_position" required="">

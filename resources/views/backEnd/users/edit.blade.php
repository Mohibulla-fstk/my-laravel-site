                ...
                <form action="{{route('users.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('company_position') is-invalid @enderror" name="company_position" value="{{ $edit_data->company_position}}" id="company_position" required="">
                    ...
                    <div class="col-sm-6 mb-3">
                        <div class="form-group">
                            ...
                            <img src="{{asset($edit_data->image)}}" alt="" style="width: 100px;height:auto;">
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

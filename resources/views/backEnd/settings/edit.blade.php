                ...
                <form action="{{route('settings.update')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('free_shipping') is-invalid @enderror" name="free_shipping"  id="free_shipping">
                                {{ $edit_data->free_shipping}}
                            </textarea>
                            @error('free_shipping')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('marque_count') is-invalid @enderror" name="marque_count"  id="marque_count">
                                {{ $edit_data->marque_count}}
                            </textarea>
                            @error('marque_count')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>

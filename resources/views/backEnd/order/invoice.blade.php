...
@section('content')
    ...
    <section class="customer-invoice ">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <a href="{{ url('admin/order/all') }}" class="no-print"><strong><i class="fe-arrow-left"></i> Back To
                            Order</strong></a>
                </div>
                <div class="col-sm-6">
                            ...
                            <tbody>
                                @foreach($order->orderdetails as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value->product_name}} <br> @if($value->product_size) <small>Size:
                            ...
                            <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                                <tbody style="background:#f1f9f8">
                                    <tr>
                                        ...
                                        <td><strong>৳{{$order->orderdetails->sum('sale_price')}} X {{ $value->qty }}</strong></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Total</strong></td>
                                        <td><strong>৳{{$order->orderdetails->sum('sale_price') * $value->qty}}</strong></td>
                                    </tr>
                                    <tr>

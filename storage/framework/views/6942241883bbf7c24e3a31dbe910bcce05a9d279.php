...
<?php $__env->startSection('css'); ?>
    ...
    <link href="<?php echo e(asset('public/backEnd/')); ?>/assets/libs/selectize/css/selectize.bootstrap3.css" rel="stylesheet"
        type="text/css" />
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $latest_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td style="width: 36px;">
                                                <img src="<?php echo e(asset(optional(optional($order->product)->image)->image ?? 'public/default.png')); ?>"
        ...
        <style>
            .chart-wrapper {
    height: 80px;        /* তোমার প্রয়োজন অনুযায়ী */
    position: relative;
}
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div>
                    ...
                    <small id="orderDiff" class="text-success"></small>
                </div>
            </div>
...
<script>
    const totalOrder = <?php echo e($total_product); ?>;

    // last values auto generate (smooth dashboard look)
    const dataPoints = [
        Math.max(totalOrder - 30, 0),
        Math.max(totalOrder - 22, 0),
        Math.max(totalOrder - 18, 0),
        Math.max(totalOrder - 10, 0),
        Math.max(totalOrder - 6, 0),
        Math.max(totalOrder - 3, 0),
        totalOrder
    ];

...
<?php $__env->startSection('title', 'Coupon Mannager'); ?>
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-primary rounded-pill">Create</a>
                    </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($coupon->max_discount ? number_format($coupon->max_discount, 2) : '-'); ?></td>
                                        <td><?php echo e(number_format($coupon->min_order_total, 2)); ?></td>
                                        <td><?php echo e($coupon->max_uses ?? '-'); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button-list">
                                                <?php if($coupon->is_active): ?>
                                                    <form method="post" action="<?php echo e(route('coupon.inactive')); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" value="<?php echo e($coupon->id); ?>" name="hidden_id">
                                                        <button type="submit"
                                                ...
                                                <?php else: ?>
                                                    <form method="post" action="<?php echo e(route('coupon.active')); ?>" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <input type="hidden" value="<?php echo e($coupon->id); ?>" name="hidden_id">
                                                        <button type="submit"
...
<?php $__env->startSection('script'); ?>
    ...
    <script
        src="<?php echo e(asset('/public/backEnd/')); ?>/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script
        src="<?php echo e(asset('/public/backEnd/')); ?>/assets/libs/datatables.net-responsive-bs5/js/responsive.bootstrap5.min.js"></script>
    <script src="<?php echo e(asset('/public/backEnd/')); ?>/assets/libs/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script
        src="<?php echo e(asset('/public/backEnd/')); ?>/assets/libs/datatables.net-buttons-bs5/js/buttons.bootstrap5.min.js"></script>

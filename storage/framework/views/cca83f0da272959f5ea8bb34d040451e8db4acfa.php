...
<?php $__env->startSection('title', 'Customer Checkout'); ?> 
 ...
 <?php $__env->startSection('content'); ?>
    ...
    <div class="coupon-totals" id="couponTotals">
        <div id="couponArea" class="<?php echo e(session('coupon') ? 'active' : ''); ?>">
            <?php if(session('coupon')): ?>
                <div class="btnforcouponapplied">
                    <span>You have Applied: <?php echo e(session('coupon.code')); ?></span>
                                ...
                                <div class="card-main">
                                    <div class="card-header1" style="padding: 10px 0px;">
                                        ...
                                        <!-- <h6>আপনার অর্ডারটি কনফার্ম করতে তথ্যগুলো পূরণ করে <span style="color:#fe5200;">"অর্ডার
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                href="tel:<?php echo e($contact->hotline); ?>"><?php echo e($contact->hotline); ?></a> এর উপরে ক্লিক
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            করুন। </h6> -->
...
unset($__errorArgs, $__bag); ?> extraborder" name="name"
                                                        value="<?php echo e(old('name')); ?>" required style="font-size:15px;padding:10px 15px; border-radius: 20px;resize: none;border: 1px solid #EBEBEB;"/>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" minlength="11" id="number" maxlength="11"
                                                        ...
                                                        class="border-rd form-control <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> extraborder"
                                                        name="phone" value="<?php echo e(old('phone')); ?>" required style="font-size:15px;padding:10px 15px; border-radius: 20px;resize: none;border: 1px solid #EBEBEB;"/>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="address" id="address"
                                                        class="border-rd form-control <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        name="address" value="<?php echo e(old('address')); ?>" required style="font-size:15px;padding:10px 15px; border-radius: 20px;resize: none;border: 1px solid #EBEBEB;"/>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <textarea type="note" id="note"
                                                        class="border-rd form-control <?php $__errorArgs = ['note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        name="note" value="<?php echo e(old('note')); ?>" placeholder="Notes about your order, e.g. special notes for delivery." required rows="4" style="font-size:15px;padding:10px 15px; border-radius: 20px;resize: none;border: 1px solid #EBEBEB;"></textarea>
...
unset($__errorArgs, $__bag); ?> extraborder"
                                                            ...
                                                            <?php $__currentLoopData = $shippingcharge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($value->id); ?>" data-charge="<?php echo e($value->amount); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php endif; ?>
                                    ...
                                    <button style="border-left:1px solid #ff9900; border-radius: 0; background: none;"
                                        type="button" class="ctrl plus cart_incrementt" data-id="<?php echo e($value->rowId); ?>"
                                        aria-label="increase">+</button>
                                </div>
                                        <div class="btnforremovecheckout">
                                            <a class="cart_removee" data-id="<?php echo e($value->rowId); ?>"><i class="fa-solid fa-trash-xmark cart_removee"></i></a>
                                        </div>
                                                            </div>
                                                    ...
                                                    <?php $__currentLoopData = $value->options->get('combo_items') ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="productcartshowarea productcartpart2forcombo" style="display: grid; grid-template-columns:10% 20% 40% 30%; gap: 0px; margin-bottom:5px; padding-bottom:5px;">
                                                            ...
                                                            <div class="part-imgpcart">
                                                                ...
                                                                <a class="cart-photo" href="<?php echo e(route('product', $p['slug'])); ?>">

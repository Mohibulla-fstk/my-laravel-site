...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(optional($generalsetting)->name ?? 'My Website'); ?></title>

  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <!-- App favicon -->
  <link rel="shortcut icon" href="<?php echo e(asset(optional($generalsetting)->favicon ?? 'default-favicon.ico')); ?>" />
...
<link href="<?php echo e(asset('public/backEnd/assets/css/toastr.min.css')); ?>" rel="stylesheet" type="text/css" />
      ...
      <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
          <li class="dropdown d-xl-block">
            <a class="nav-link dropdown-toggle waves-effect waves-light"
              href="<?php echo e(route('home')); ?>" target="_blank"> <i data-feather="globe"></i></a>
          </li>
          ...
          <li class="dropdown notification-list topbar-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-lg">
                  ...
                  <!-- Footer -->
                  <a href="<?php echo e(route('notifications.all')); ?>" class="dropdown-item text-center text-primary notify-item notify-all" id="notify-footer">
                      View all
          ...
          <li class="dropdown notification-list topbar-dropdown">
            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
              ...
              <img src="<?php echo e(asset(Auth::user()->image)); ?>" alt="user-image" class="rounded-circle" />
              <span class="pro-user-name ms-1"> <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->company_position); ?> <i class="mdi mdi-chevron-down"></i> </span>
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-end profile-dropdown">
              ...
              <!-- item-->
              <a href="<?php echo e(route('locked')); ?>" class="dropdown-item notify-item">
                <i class="fe-lock"></i>
        ...
        <div class="logo-box">
          <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo logo-dark text-center">
            <span class="logo-sm">
              <img src="<?php echo e(asset(optional($generalsetting)->dark_logo ?? 'default-logo.png')); ?>" alt="" height="50" />
            </span>
            <span class="logo-lg">
              <img src="<?php echo e(asset(optional($generalsetting)->dark_logo ?? 'default-logo.png')); ?>" alt="" height="50" />
            </span>
    ...
    <div class="left-side-menu">
      <div class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
          <img src="<?php echo e(asset('public/backEnd/')); ?>/assets/images/users/user-1.jpg" alt="user-img" title="Mat Helme"
        ...
        <div id="sidebar-menu">
          <ul id="side-menu">
            ...
            <li>
              <a href="<?php echo e(route('notifications.all')); ?>">
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-orders">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('admin.orders', ['slug' => 'all'])); ?>"><i data-feather="file-plus"></i> All
                      Order</a>
                  </li>
                  <?php $__currentLoopData = $orderstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                      <a href="<?php echo e(route('admin.orders', ['slug' => $value->slug])); ?>"><i
                          data-feather="file-plus"></i><?php echo e($value->name); ?></a>
                    </li>
            ...
            <li>
              ...
              <div class="collapse" id="siebar-product">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('products.index')); ?>"><i data-feather="file-plus"></i> Products</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('combos.index')); ?>"><i data-feather="file-plus"></i> Combo Offer</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('categories.index')); ?>"><i data-feather="file-plus"></i> Categories</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('subcategories.index')); ?>"><i data-feather="file-plus"></i> Subcategories</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('childcategories.index')); ?>"><i data-feather="file-plus"></i> Childcategories</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('brands.index')); ?>"><i data-feather="file-plus"></i> Brands</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('colors.index')); ?>"><i data-feather="file-plus"></i> Colors</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('sizes.index')); ?>"><i data-feather="file-plus"></i> Sizes</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('products.price_edit')); ?>"><i data-feather="file-plus"></i> Price Edit</a>
                  </li>
            ...
            <li>
              <a href="<?php echo e(route('allCategories.index')); ?>"><i data-feather="grid" class="noti-icon"></i>
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-product-review">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('reviews.index')); ?>"><i data-feather="file-plus"></i> All Reviews</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('reviews.pending')); ?>"><i data-feather="file-plus"></i> Create</a>
                  </li>

                  <li>
                    <a href="<?php echo e(route('reviews.pending')); ?>"><i data-feather="file-plus"></i> Pending Reviews
                      (<?php echo e($pending_reviews); ?>)</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-landing-page">
                <ul class="nav-second-level">
                  ...
                  <li>
                    <a href="<?php echo e(route('campaign.create')); ?>"><i data-feather="file-plus"></i> Create</a>
                  </li>
                  <li>
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-users">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('users.alluser')); ?>"><i data-feather="file-plus"></i> All User</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('users.index')); ?>"><i data-feather="file-plus"></i> Assign User</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('roles.index')); ?>"><i data-feather="file-plus"></i> User Roles</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('permissions.index')); ?>"><i data-feather="file-plus"></i> User Permissions</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('customers.index')); ?>"><i data-feather="file-plus"></i> Customers</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="collapse" id="siebar-sitesetting">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('settings.index')); ?>"><i data-feather="file-plus"></i> General Setting</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="file-plus"></i> Pixels Setting</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('socialmedias.index')); ?>"><i data-feather="file-plus"></i> Social Media</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('contact.index')); ?>"><i data-feather="file-plus"></i> Contact</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('pages.index')); ?>"><i data-feather="file-plus"></i> Create Page</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('shippingcharges.index')); ?>"><i data-feather="file-plus"></i> Shipping Charge</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('orderstatus.index')); ?>"><i data-feather="file-plus"></i> Order Status</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-api-integration">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('paymentgeteway.manage')); ?>"><i data-feather="file-plus"></i> Payment Gateway</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('smsgeteway.manage')); ?>"><i data-feather="file-plus"></i> SMS Gateway</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('courierapi.manage')); ?>"><i data-feather="file-plus"></i> Courier API</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="collapse" id="sidebar-pixel-gtm">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('tagmanagers.index')); ?>"><i data-feather="file-plus"></i> Tag Manager</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="file-plus"></i> Pixel Manage</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li>
              ...
              <div class="collapse" id="siebar-banner">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('banner_category.index')); ?>"><i data-feather="file-plus"></i> Banner Category</a>
                  </li>
                  <li>
            ...
            <li>
              ...
              <div class="collapse" id="sitebar-report">
                <ul class="nav-second-level">
                  <li>
                    <a href="<?php echo e(route('admin.stock_report')); ?>"><i data-feather="file-plus"></i> Stock Report</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('customers.ip_block')); ?>"><i data-feather="file-plus"></i> IP Block</a>
                  </li>
                  <li>
                    <a href="<?php echo e(route('admin.order_report')); ?>"><i data-feather="file-plus"></i> Order Reports</a>
                  </li>
                </ul>
              </div>
            </li>
...
document.addEventListener('click', function(e) {
    ...
    if(item){
        ...
        fetch('<?php echo e(url("/notifications/read")); ?>/' + id, { 
            method: 'POST', 
            headers: { 
...
fetchNotifications();
  ...
  <script>
    setInterval(function () {
        fetch("<?php echo e(route('check.user.status')); ?>", {
            headers: {
        ...
        .then(data => {
            if (data.logout === true) {
                ...
                window.location.href = "<?php echo e(url('/myfashionpanel')); ?>";
            }
        });
...
</html><?php /**PATH C:\xampp\htdocs\nmfashion\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>